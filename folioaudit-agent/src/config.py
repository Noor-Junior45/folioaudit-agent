"""
AMC registry. Top 10 Indian Asset Management Companies by AUM.

Under SEBI regulations, each AMC discloses its full scheme portfolio as of
the end of each calendar month by the 10th of the following month.

`portal_url` is the official statutory download page where files can be viewed/verified.
`disclosure_url` supports template tokens:
...
AMCS = {
    "nippon_india": {
        ...
        "portal_url": "https://mf.nipponindiaim.com/investor-services/downloads/factsheets-monthly-portfolios",
    ...
    "sbi": {
        ...
        "portal_url": "https://www.sbimf.com/en-us/downloads/portfolio-disclosures",
    ...
    "icici_pru": {
        ...
        "portal_url": "https://www.icicipruamc.com/downloads/monthly-portfolio-disclosure",
    ...
    "hdfc": {
        ...
        "portal_url": "https://www.hdfcfund.com/statutory-disclosure/monthly-portfolio",
    ...
    "kotak": {
        ...
        "portal_url": "https://www.kotakmf.com/downloads/statutory-disclosure/monthly-portfolio",
    ...
    "aditya_birla": {
        ...
        "portal_url": "https://mutualfund.adityabirlacapital.com/forms-and-downloads/monthly-portfolio",
    ...
    "uti": {
        ...
        "portal_url": "https://www.utimf.com/forms-and-downloads/monthly-portfolio-disclosure",
    ...
    "mirae_asset": {
        ...
        "portal_url": "https://www.miraeassetmf.co.in/downloads/statutory-disclosure/monthly-portfolio-disclosures",
    ...
    "whiteoak": {
        ...
        "portal_url": "https://mf.whiteoakamc.com/downloads/portfolio-disclosures",
    ...
    "motilal_oswal": {
        ...
        "portal_url": "https://www.motilaloswalmf.com/downloads/mutual-fund/scheme-portfolio",
